...
class base_config(object):
    ...
    DEFAULT_SHOULD_SCHEDULE_SWITCH_METRICS_UPDATES = '1'
    SHOULD_SCHEDULE_SWITCH_METRICS_UPDATES = os.environ.get(
        'SHOULD_SCHEDULE_SWITCH_METRICS_UPDATES',
        DEFAULT_SHOULD_SCHEDULE_SWITCH_METRICS_UPDATES)
